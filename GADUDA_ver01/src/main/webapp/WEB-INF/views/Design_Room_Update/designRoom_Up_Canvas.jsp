...
$(document).ready(function(){
	...
	var canvasOffset=$("#design_up_Include_body").offset();
	...
	function get_DesignRoom_data(){
		var designRoom_up_con={"designRoom_up_num":updata_num};
		$.ajax({
			type:"POST",
			data:designRoom_up_con,
			url: "${URLs.URI_DESIGNROOM_CANVAS_UP_FURNITURE_DATA_FULL}",
			success:function(data){
				
				furniture_up=data.furniture_up;
				furniture_up_room=data.furniture_up_room;
				...
				for(var i=0; i<furniture_up.length;i++){
					var fig_img = new Image();
					
					
					fig_img.src = furniture_up[i].fur_arr_basic_img_loc;
					fig_num_arr[fig_arr_length]=furniture_up[i].fur_no;
					fig_img_arr[fig_arr_length]=fig_img;
					
					fig_img_X_arr[fig_arr_length]=furniture_up[i].arr_fur_X_value;
					fig_img_Y_arr[fig_arr_length]=furniture_up[i].arr_fur_Y_value;
					
					fig_img_state_arr[fig_arr_length]=furniture_up[i].arr_fur_state;
					
					
					for(var j = 0; j<furniture_data.length;j++){
						if(furniture_up[i].fur_no==furniture_data[j].fur_no){
							if(furniture_up[i].arr_fur_state=='상단'){
								fig_img_width_length_arr[fig_arr_length]=furniture_data[j].fur_width/10;
								fig_img_height_length_arr[fig_arr_length]=furniture_data[j].fur_depth/10;
							}
							else if(furniture_up[i].arr_fur_state=='왼쪽'){
								fig_img_width_length_arr[fig_arr_length]=furniture_data[j].fur_depth/10;
								fig_img_height_length_arr[fig_arr_length]=furniture_data[j].fur_width/10;
							}
							else if(furniture_up[i].arr_fur_state=='하단'){
								fig_img_width_length_arr[fig_arr_length]=furniture_data[j].fur_width/10;
								fig_img_height_length_arr[fig_arr_length]=furniture_data[j].fur_depth/10;
							}
							else if(furniture_up[i].arr_fur_state=='오른쪽'){
								fig_img_width_length_arr[fig_arr_length]=furniture_data[j].fur_depth/10;
								fig_img_height_length_arr[fig_arr_length]=furniture_data[j].fur_width/10;
							}
						}
					...
					fig_arr_length++;
					roomMake_canvas_window_one_img.src = furniture_up_room.room_img_src;
				}
			}
		});
	}
