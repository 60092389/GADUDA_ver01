...
$(document).ready(function(){
	...
	function roomMake_Img_TextPosition(){
		...
		$("#Img_lengthText1").css("position","absolute").css("top",roomMake_canvas_img_Y_arr[select_img_num]+150).css("left",roomMake_canvas_img_X_arr[select_img_num]+(roomMake_canvas_img_width_arr[select_img_num]/2)+500);
